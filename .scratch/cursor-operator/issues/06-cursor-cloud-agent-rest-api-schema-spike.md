...
# Historical Cursor Cloud Agent REST API schema spike
...
The PRD now selects the official Cursor SDK through a small Node helper as the MVP runtime path. This REST spike remains useful historical context and a possible future fallback if Cursor exposes REST start and wait semantics that match the SDK.
